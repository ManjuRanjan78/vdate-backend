...
export declare class SocketGateway implements OnGatewayConnection, OnGatewayDisconnect {
    ...
    private setSearchIntent;
    private isSearchIntentActive;
    private getQueueState;
    private getSocketForUser;
    private logMatchmakingState;
    private resumeUserSearch;
    ...
    handleRejectCall(client: Socket, data: any): Promise<void>;
